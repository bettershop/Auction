# 来客推拍卖 PC 商城 (LAIKETUI Auction Mall)

来客推拍卖 PC 端商城是一个基于 Nuxt.js 2 构建的在线拍卖电商平台，支持竞拍、专场、店铺等多种交易模式，为用户提供完整的拍卖购物体验。
