...
系统同时提供完整的移动端体验，覆盖 H5、小程序、APP 三大终端，核心功能如下：

### 1. 个人中心

移动端个人中心聚合用户资产与业务入口：

- **用户信息**：头像、昵称、竞拍号牌、会员到期时间、实名认证状态
- **资产概览**：优惠券数量、积分、余额、我的收藏
- **VIP会员中心**：专属权益入口
- **店铺与银行卡**：我的店铺管理、银行卡绑定
- **拍卖订单**：直播拍、一口价、英式拍三类订单快捷入口
- **商城订单**：待付款、待发货、待收货、待评价、退款/售后，支持角标数量提醒
- **功能中心**：我的拼团、我的秒杀、我的砍价、身份认证、我的兑换
- **底部导航**：首页、拍卖、商城、我的四大一级入口
...
- **专场信息**：专场名称、场次标题（如"珍宝阁2026春季和田玉拍卖会"）
- **视频直播**：实时展示拍卖师画面，支持全屏切换
- **拍品展示**：大图呈现当前拍品，多币种价格对照（RMB / HKD / USD / TWD）
- **出价交互**：当前价、下口价清晰展示，支持解锁出价、加减价操作
- **出价记录**：现场竞价实时滚动，标记领先/出局状态
- **本场拍品**：一键查看全部拍品列表

![专场详情-视频直播](adv/拍品详情-进行中-视频直播.png)
...
- **拍品信息**：拍品缩略图、名称、Lot编号
- **费用明细**：拍品估价、应付保证金、当前缴纳状态、缴纳时间
- **支付方式**：余额支付（显示可用余额）、支付宝、微信支付
- **一键缴纳**：底部醒目按钮快速完成支付
- **规则说明**：保证金退回、扣除规则清晰告知

![缴纳保证金](adv/专场详情-场次进行中-缴纳保证金.png)
...
- **画廊浏览**：拍品大图滑动查看，支持图片计数
- **核心信息**：Lot编号、拍品名称、拍卖行、当前价、起拍价、出价次数
- **拍卖行信息**：拍卖行头像、名称、地址、资质介绍
- **来源出处**：拍品来源、著录、备注等权威信息
- **竞买须知**：平台免责声明及竞拍规则
- **相似推荐**：基于当前拍品推荐相似商品与同场拍品
- **底部操作**：分享、收藏、客服、提醒我、抢先出价

![拍品详情-来源出处](adv/拍品详情-进行中-来源出处.png)
